...
if id == 1:
    ...
    ta = TransportAuthority("NATIONAL TRANSPORT AUTHORITY",
                            PORT, (5, 119), (77, 119))
    print("public key directory is ")
    print(ta.publicKeyDirectory)
...
try:
    ...
    if e.errno == errno.EADDRINUSE:
        print(f"Port {PORT} is already in use. Continuing further.")



print("--> Listening on port:", PORT)
global_authority = list()
while True:
    c, addr = serv.accept()
    ...
    if msg['type'] == 1:
        ...
        if(PORT==12342):
            global_authority.append("DELHI TRANSPORT")
            print(global_authority)
